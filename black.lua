...
send(msg.chat_id,msg.id,"➢ مرحبا عزيزي في مصنع الحمايه المجاني لسورس العرب \n➢ مبرمج السورس @zGzzz","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
if text == "➢ الغاء" then
Redis:del(black..msg.sender.user_id.."make:bot")
send(msg.chat_id,msg.id,"➢ تم الغاء امر صناعة البوت")
return false 
end
local url = https.request("http://api.telegram.org/bot"..text.."/getme")
local json = JSON.decode(url)
...
----
if text == 'المطور علي 72' or text == 'مبرمج السورس' or text == 'علي 72' then  
local UserId_Info = LuaTele.searchPublicChat("zGzzz")
...
local TestText = "𝟕𝟐 〠ًٍ𝘈ٌٍَِِٓ𝘓ٍٍٕ𝘐 ߷ 🇮🇶\n— — — — — — — — —\n ❍*َdev name➢* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n❍*َbio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𝟕𝟐 〠ًٍ𝘈ٌٍَِِٓ𝘓ٍٍٕ𝘐 ߷ 🇮🇶', url = "https://t.me/zGzzz"}
},
}
...
{
{text = 'Sσυяcє αℓαяαв', url = "https://t.me/zTzo6"},
},
}
local msg_id = msg.id/2097152/0.5 
...
photo = "https://t.me/ztakk/2"
local T =[[
• ──────⚜────── • 
 ^÷^ Sσυяcє αℓαяαв ^÷^
• ──────⚜────── • 
^÷^ ⱰЄV >> [ 𝟕𝟐 〠ًٍ𝘈ٌٍَِِٓ𝘓ٍٍٕ𝘐 ߷ 🇮🇶 .](t.me/zGzzz) ^÷^
• ──────⚜────── • 
^÷^ [ Sσυяcє αℓαяαв .](t.me/zTzo6) ^÷^
• ──────⚜────── • 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ِّّSσυяcє αℓαяαв', url = 't.me/zTzo6'}, 
},
}
